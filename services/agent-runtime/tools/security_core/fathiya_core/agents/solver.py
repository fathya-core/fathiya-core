"""
agents/solver.py — وكيل توليد الحلول والمراجعة
يعيد بناء المنطق الأصلي من domains/security/solver.py
...
class ProblemSolver:
    ...
    def solve(self, user_input: str, framed_problem: FramedProblem) -> str:
        """إنتاج الرد المناسب بناءً على السؤال وتقرير التشخيص"""
...
"""
        ...
        framed_json: str = framed_problem.model_dump_json(indent=2)
...
"""
    ...
    def revise(self, user_input: str, original_answer: str, revision_note: str) -> str:
        """تعديل جواب سابق بناءً على ملاحظة مراجعة"""
        system_instruction: str = """
أنت Solver في FATHIYA CORE.
