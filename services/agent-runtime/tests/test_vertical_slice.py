...
class AgentRuntimeVerticalSliceTests(unittest.TestCase):
    ...
    def test_local_capability_inventory_probes_and_caches_execution_mesh(self) -> None:
        ...
        self.assertEqual(result["core_capability_count"], 6)
        self.assertEqual(result["optional_capability_count"], 4)
        self.assertEqual(result["optional_attention_count"], 2)
        self.assertEqual(result["core_ready_count"], 4)
        self.assertEqual(by_id["claude_code"]["authenticated"], True)
        self.assertFalse(by_id["claude_code"]["required_for_core"])
        self.assertTrue(by_id["claude_code"]["optional"])
        self.assertEqual(by_id["github_codespaces"]["codespace_count"], 2)
        self.assertFalse(by_id["github_codespaces"]["required_for_core"])
        self.assertTrue(by_id["github_codespaces"]["optional"])
        ...
        self.assertFalse(by_id["zapier_mcp"]["required_for_core"])
        self.assertTrue(by_id["zapier_mcp"]["optional"])
