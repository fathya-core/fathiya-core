...
![Vibe Coding is Over illustration of three ai generated landing pages with the words IT’S OVER written at the top in large text](https://miro.medium.com/v2/resize:fit:1000/1*1OGKfKCooEZbKCSoSXXY8g.png)
...
![Ikea table assembly instructions](https://miro.medium.com/v2/resize:fit:700/1*GHZOrz3p1FH3i6ILGkN6Pw.jpeg)
...
![Slop in design in 2006, 2016, 2026](https://miro.medium.com/v2/resize:fit:700/1*-deNrN1a-936GGwcyryarw.png)
...
![Figma AutoLayout example](https://miro.medium.com/v2/resize:fit:626/1*r_Xg-vrklcT5CexVuyoRzQ.gif)
...
![innovators pretend to be steve jobs](https://miro.medium.com/v2/resize:fit:700/1*vvDIPmqaWbFq-TdgfQ5uMQ.png)
...
![A graph showing a decline of interest of people in new products](https://miro.medium.com/v2/resize:fit:700/1*TgZIDg_PRCkbuHzz0IZoBQ.png)
...
![Minimum Viable Precision of executing a digital product](https://miro.medium.com/v2/resize:fit:700/1*qpfyAu533wXnyqedCDzc9A.jpeg)
...
![Just using AI has very little effect if someone is low skilled. High skilled people can benefit a lot more.](https://miro.medium.com/v2/resize:fit:700/1*773MVpHtuA2gzoJOR4BoRA.png)
...
![AI slop examples](https://miro.medium.com/v2/resize:fit:700/1*sBFI5uF_ZPqxI3nPe8uggQ.png)
...
It’s the AI-generated app icon that’s a geometric abstract shape in purple-blue gradient with [glassmorphism](https://medium.com/user-experience-design-1/glassmorphism-in-user-interfaces-1f39bb1308c9) on top. It’s the dashboard that displays 47 data points at once because more is better, right?
...
![ALL AI logos look a little weird](https://miro.medium.com/v2/resize:fit:700/1*IuWFG1xSMj34SiNEsG85qw.png)
...
You spend more time watching videos, reading articles and comparing benchmarks than actually building. You subscribe to AI tool newsletters that tell you about other AI tools. You follow founders on X who post screenshots of their “[stack](/my-complete-web-design-build-workflow-for-2026-3279e813b3fe)” like it’s a personality trait.

![AI may be a multiplier but if your skill is 0, the result is still 0](https://miro.medium.com/v2/resize:fit:700/1*m_HomoKnIvopCBI8FQ-koQ.png)
...
![Classic “steal this prompt” instagram posts](https://miro.medium.com/v2/resize:fit:700/1*G9UXQD2v7LVl584Bf3dHJQ.png)
...
[Builders are getting dumber.](/prompts-are-making-you-stupid-a3d3cc7b5eb0) It’s harder for them to express what they want. Regular people seem to be even more lost in all that chaos.
...
It’s like outsourcing outsourcing taste and creativity to a CSV file downloaded from a [Gumroad](https://hype4academy.gumroad.com) page.
...
![Plan and write out the main goals of your project](https://miro.medium.com/v2/resize:fit:700/1*fKjnG5PyyJtP5lUL-tMUhg.png)
...
![Apple design quality and why founders should learn from it](https://miro.medium.com/v2/resize:fit:700/1*paqfulG079moYxvyUgR69A.jpeg)
...
![Learn how layout, typography, color works.](https://miro.medium.com/v2/resize:fit:700/1*km7PyZ9rgAKj3-dZwgb89A.png)
...
![Average products have a short lifespan and less future revenue](https://miro.medium.com/v2/resize:fit:700/1*9qzavLTbr4oSUB3omuFc5Q.png)
...
![Revenue can go slightly up with AI use, but that’s short lived and we’re almost past the point of diminishing returns](https://miro.medium.com/v2/resize:fit:700/1*l4X3xluyNZ-siQfz9j3Rvw.png)
...
I build beautiful wellness and [longevity](https://longevitydeck.com) apps, yes, also using AI. You can [catch me on X](https://x.com/michalmalewicz) or [YouTube](https://youtube.com/@deliberatelydefiant). _No AI was used to write this article._ **It would be pointless. I write from the heart.**